...
function generatePoem(event) {
  ...
  let context = `User Instructions: you are a romanic poem expert and love to write short poems. Your mission is to generate a 4 line poem and separate each line with a <br>. Make sure to follow the user instructions.
  `;
